 ...
 * 
 * Note: Much of this code is copied from SubmissionController with only the routes
 *       changed, so as not to change/break the existing functionality of CSNS.
 *       If AGOPA ever gets implemented for real, then this class needs to be changed 
 *       to use the same logic as SubmissionController without copying the code.
 *       OnlineSubmission achieves this by having SubmissionConroller "know" that some
 *       submissions are OnlineSubmissions, and redirecting when it encounters one.
 *       However, Muna and I made the choice to touch the non-AGOPA code at this stage
 *       of the project (December 2018) so at this point SubmissionController is not
 *       aware that CodingSubmissions exist.
 *     
 * 
 */
...
public class CodingSubmissionController  {
        ...
        HttpServletResponse response )
    {
        ...
        switch( assignment.getDescription().getType() )
        {
            case TEXT:
                ...
                return "submission/coding/description";
        ...
        @RequestParam MultipartFile uploadedFile, ModelMap models )
    {
        ...
        boolean isInstructor = submission.getAssignment()
            .getSection()
            .isInstructor( user );
        String view = additional && isInstructor ? "/submission/coding/add?id=" + id
            : "/submission/coding/view?id=" + id;
        ...
        @RequestParam Calendar dueDate )
    {
        ...
        return "redirect:/submission/coding/grade?id=" + id;
    }

    @RequestMapping(value = "/submission/coding/edit", params = "grade")
    ...
    @RequestMapping(value = "/submission/coding/edit", params = "comments")
    ...
    @RequestMapping(value = "/submission/coding/email", params = "submissionId")
        ...
        throws IOException, TemplateException
    {
        ...
        return "redirect:/submission/coding/grade?id=" + submissionId;
    }

    @RequestMapping(value = "/submission/coding/email", params = "assignmentId")
        ...
        throws IOException, TemplateException
    {
        ...
        for( Submission submission : assignment.getSubmissions() )
            emailGrade( submission );
        return "redirect:/submission/coding/list?assignmentId=" + assignmentId;
    }    
